...
// GitHub is a brand mark — Lucide removed brand icons, so this stays inline SVG.
const GithubIcon = (
    ...
    >
      <Stack direction="row" justify="space-between" align="center" gap={4} style={{ height: HEADER_H, padding: "0 24px" }}>
        <Stack direction="row" align="center" gap={2}>
          {!isHome && isMobile ? (
            <IconButton variant="ghost" aria-label="Toggle navigation" icon={<MenuIcon size={20} />} onClick={nav.onToggle} />
          ) : null}
