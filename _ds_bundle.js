...
const __ds_ns = (window.TwicoUiDesignSystem_f2f16a = window.TwicoUiDesignSystem_f2f16a || {});

const __ds_scope = {};

(__ds_ns.__errors = __ds_ns.__errors || []);

// assets/twico-icons.js
try { (() => {
...
(function () {
  function resolve(name) {
    ...
    var pascal = name.replace(/(^|[-_ ])(\w)/g, function (_, __, c) {
  ...
  window.TwicoIcon = function TwicoIcon(props) {
    ...
    var childTuples = Array.isArray(node) ? Array.isArray(node[0]) ? node : node[2] || [] : [];
...
`;
const ChevronSep = () => /*#__PURE__*/React.createElement("svg", {
  viewBox: "0 0 24 24",
  fill: "none",
  stroke: "currentColor",
  strokeWidth: "2.2",
...
function Breadcrumb({
  ...
  const sep = separator || /*#__PURE__*/React.createElement(ChevronSep, null);
  let display = items;
  let collapsed = false;
  ...
  return /*#__PURE__*/React.createElement("nav", _extends({
    className: `twc-breadcrumb ${className}`,
    "aria-label": "Breadcrumb"
  }, rest), display.map((it, i) => {
    const last = i === display.length - 1;
    return /*#__PURE__*/React.createElement(React.Fragment, {
      key: i
    }, it.ellipsis ? /*#__PURE__*/React.createElement("button", {
      className: "twc-breadcrumb__ellipsis",
    ...
    }, it.icon) : null, it.label), !last ? /*#__PURE__*/React.createElement("span", {
      className: "twc-breadcrumb__sep",
      "aria-hidden": "true"
    }, sep) : null);
  }));
}
...
function Button({
  ...
  return /*#__PURE__*/React.createElement(Tag, _extends({
    ...
    className: "twc-btn__icon",
    "aria-hidden": "true"
  }, leftIcon) : null, children, rightIcon ? /*#__PURE__*/React.createElement("span", {
    className: "twc-btn__icon",
    "aria-hidden": "true"
  }, rightIcon) : null, loading ? /*#__PURE__*/React.createElement("span", {
    className: "twc-btn__spinner",
    "aria-hidden": "true"
...
function Carousel({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    className: "twc-carousel__viewport"
  }, /*#__PURE__*/React.createElement("div", {
    className: "twc-carousel__track",
    style: {
      transform: `translateX(-${index * 100}%)`
    }
  }, slides.map((s, i) => /*#__PURE__*/React.createElement("div", {
    className: "twc-carousel__slide",
    key: i,
    "aria-hidden": i !== index,
    role: "group",
    "aria-roledescription": "slide",
    "aria-label": `${i + 1} of ${count}`
  }, s)))), showArrows && count > 1 ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
    className: "twc-carousel__arrow",
    "data-dir": "prev",
    "aria-label": "Previous",
    disabled: atStart,
    onClick: () => go(index - 1)
    ...
    d: "m9 18 6-6-6-6"
  })))) : null, showDots && count > 1 ? /*#__PURE__*/React.createElement("div", {
    className: "twc-carousel__dots"
  }, slides.map((_, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    className: "twc-carousel__dot",
...
function Chart({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    return /*#__PURE__*/React.createElement("line", {
      key: i,
      className: "twc-chart__grid",
      x1: padL,
      y1: gy,
      x2: W - padR,
      y2: gy
    });
  }) : null, showAxis ? Array.from({
    length: ticks + 1
  }).map((_, i) => {
    ...
    return data.map((d, gi) => keys.map((k, si) => {
      ...
      return /*#__PURE__*/React.createElement("rect", {
        ...
        rx: "3",
        style: {
          fill: keys.length > 1 ? SERIES_COLORS[si % SERIES_COLORS.length] : undefined
        }
      }, /*#__PURE__*/React.createElement("title", null, `${d.label ?? gi}: ${fmt(v)}`));
    }));
  })() : null, type === "line" ? keys.map((k, si) => {
    ...
    }, /*#__PURE__*/React.createElement("title", null, `${data[i].label ?? i}: ${fmt(Number(data[i][k]) || 0)}`))));
  }) : null, showAxis ? data.map((d, i) => {
  ...
  }) : null), showLegend && keys.length > 1 ? /*#__PURE__*/React.createElement("div", {
    className: "twc-chart__legend"
  }, keys.map((k, si) => /*#__PURE__*/React.createElement("span", {
    key: k,
    className: "twc-chart__leg"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-chart__leg-sw",
    style: {
...
function ColorPicker({
  ...
  const commit = next => {
    ...
    setHsv(next);
    if (value === undefined) setInternal(h);
    onChange?.(h);
  };
  const dragArea = e => {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-cp ${className}`,
    ref: wrapRef
  }, rest), label ? /*#__PURE__*/React.createElement("span", {
    className: "twc-cp__label"
    ...
    className: "twc-cp__swatch",
    style: {
      background: hex
    }
  }), /*#__PURE__*/React.createElement("span", {
    className: "twc-cp__value"
  }, hex), /*#__PURE__*/React.createElement("span", {
    className: "twc-cp__chev",
    "aria-hidden": "true"
  }, /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
    ...
    className: "twc-cp__area-sat"
  }), /*#__PURE__*/React.createElement("div", {
    className: "twc-cp__area-val"
  }), /*#__PURE__*/React.createElement("span", {
    className: "twc-cp__area-knob",
    style: {
      left: `${hsv.s}%`,
      top: `${100 - hsv.v}%`,
      background: hex
    ...
    className: "twc-cp__hue-knob",
    style: {
      left: `${hsv.h / 360 * 100}%`
    }
  })), /*#__PURE__*/React.createElement("div", {
    className: "twc-cp__foot"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-cp__swatch",
    style: {
      background: hex
  ...
  })), presets && presets.length ? /*#__PURE__*/React.createElement("div", {
    className: "twc-cp__presets"
  }, presets.map(p => /*#__PURE__*/React.createElement("button", {
    key: p,
    type: "button",
    className: "twc-cp__preset",
    "data-active": p.toLowerCase() === hex.toLowerCase() || undefined,
    style: {
      background: p
    },
    "aria-label": p,
...
function CommandPalette({
  ...
  const filtered = React.useMemo(() => commands.filter(c => !q || c.label.toLowerCase().includes(q) || (c.keywords || "").toLowerCase().includes(q) || (c.group || "").toLowerCase().includes(q)), [commands, q]);
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "twc-cmdk__overlay",
    onMouseDown: e => {
      if (e.target === e.currentTarget) onClose?.();
    }
  }, /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-cmdk ${className}`,
    role: "dialog",
    "aria-modal": "true",
    "aria-label": "Command palette"
  }, rest), /*#__PURE__*/React.createElement("div", {
    className: "twc-cmdk__search"
  }, /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    ...
    className: "twc-cmdk__kbd"
  }, "esc")), /*#__PURE__*/React.createElement("div", {
    className: "twc-cmdk__list",
    ref: listRef
  }, flat.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "twc-cmdk__empty"
  }, emptyText) : groups.map(g => /*#__PURE__*/React.createElement("div", {
    key: g.key || "_",
    role: "group"
  }, g.key ? /*#__PURE__*/React.createElement("div", {
    className: "twc-cmdk__group-label"
  }, g.key) : null, g.items.map(c => {
    idx += 1;
    const i = idx;
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: "twc-cmdk__item-ic",
      "aria-hidden": "true"
    }, c.icon) : null, /*#__PURE__*/React.createElement("span", {
      className: "twc-cmdk__item-main"
    }, /*#__PURE__*/React.createElement("span", {
      className: "twc-cmdk__item-label"
    }, c.label), c.description ? /*#__PURE__*/React.createElement("span", {
      className: "twc-cmdk__item-desc"
    }, c.description) : null), c.shortcut ? /*#__PURE__*/React.createElement("span", {
      className: "twc-cmdk__item-sc"
    }, c.shortcut) : null);
  }))))));
}
...
function Badge({
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    className: `twc-badge ${className}`,
    "data-tone": tone,
    "data-variant": variant,
    "data-size": size
  }, rest), dot ? /*#__PURE__*/React.createElement("span", {
    className: "twc-badge__dot"
  }) : null, children);
}
...
function Card({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    className: "twc-card__header"
  }, title ? /*#__PURE__*/React.createElement("div", {
    className: "twc-card__title"
  }, title) : null, subtitle ? /*#__PURE__*/React.createElement("div", {
    className: "twc-card__subtitle"
  }, subtitle) : null) : null, children ? /*#__PURE__*/React.createElement("div", {
    className: "twc-card__body"
  }, children) : null, footer ? /*#__PURE__*/React.createElement("div", {
    className: "twc-card__footer"
  }, footer) : null);
}
...
function Tag({
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    className: `twc-tag ${className}`,
    "data-no-remove": !onRemove || undefined
  }, rest), leftIcon, children, onRemove ? /*#__PURE__*/React.createElement("button", {
    className: "twc-tag__remove",
    onClick: onRemove,
    "aria-label": "Remove",
    type: "button"
  }, /*#__PURE__*/React.createElement("svg", {
...
const fmtD = d => d ? d.toLocaleDateString(undefined, {
  month: "short",
  day: "numeric",
  year: "numeric"
}) : "";
function DateRangePicker({
  ...
  const dows = Array.from({
    length: 7
  }, (_, i) => DOW[(i + weekStartsOn) % 7]);
  const edgeOf = t => {
    const s = ymd(range.start),
      e = ymd(range.end) || (range.start && hover ? ymd(hover) : null);
    const lo = s != null && e != null ? Math.min(s, e) : s,
      hi = s != null && e != null ? Math.max(s, e) : s;
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-drp ${className}`,
    ref: wrapRef
  }, rest), label ? /*#__PURE__*/React.createElement("span", {
    className: "twc-drp__label"
  }, label) : null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "twc-drp__text",
    "data-placeholder": !range.start || undefined
  }, range.start ? text : placeholder)), open ? /*#__PURE__*/React.createElement("div", {
    className: "twc-drp__pop",
    role: "dialog",
    "aria-label": "Choose date range"
  }, presets ? /*#__PURE__*/React.createElement("div", {
    className: "twc-drp__presets"
  }, [["Last 7 days", 7], ["Last 14 days", 14], ["Last 30 days", 30], ["Last 90 days", 90]].map(([lbl, n]) => /*#__PURE__*/React.createElement("button", {
    key: n,
    className: "twc-drp__preset",
    onClick: () => applyPreset(n)
  }, lbl))) : null, /*#__PURE__*/React.createElement("div", {
    className: "twc-drp__cal"
  }, /*#__PURE__*/React.createElement("div", {
    className: "twc-drp__head"
  }, /*#__PURE__*/React.createElement("button", {
    className: "twc-drp__nav",
    ...
    className: "twc-drp__grid"
  }, dows.map(d => /*#__PURE__*/React.createElement("div", {
    key: d,
    className: "twc-drp__dow"
  }, d)), Array.from({
    length: 42
  }).map((_, i) => {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      "data-in": inRange(t) || undefined,
      "data-edge": edgeOf(t) || undefined,
...
function DatePicker({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-dp ${className}`,
    ref: wrapRef
  }, rest), label ? /*#__PURE__*/React.createElement("label", {
    className: "twc-dp__label",
    htmlFor: fieldId
  }, label) : null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "twc-dp__text",
    "data-placeholder": !selected || undefined
  }, selected ? fmt(selected) : placeholder), clearable && selected && !disabled ? /*#__PURE__*/React.createElement("button", {
    className: "twc-dp__clear",
    "aria-label": "Clear",
    onClick: e => {
      e.stopPropagation();
      pick(null);
    ...
    className: "twc-dp__head"
  }, /*#__PURE__*/React.createElement("button", {
    className: "twc-dp__nav",
    "aria-label": "Previous",
    onClick: () => setView(mode === "months" ? new Date(y - 1, m, 1) : new Date(y, m - 1, 1))
  }, /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    ...
    className: "twc-dp__title",
    onClick: () => setMode(mode === "days" ? "months" : "days")
  }, mode === "days" ? `${MONTHS[m]} ${y}` : y), /*#__PURE__*/React.createElement("button", {
    className: "twc-dp__nav",
    "aria-label": "Next",
    onClick: () => setView(mode === "months" ? new Date(y + 1, m, 1) : new Date(y, m + 1, 1))
  }, /*#__PURE__*/React.createElement("svg", {
    ...
    className: "twc-dp__grid"
  }, dows.map(d => /*#__PURE__*/React.createElement("div", {
    key: d,
    className: "twc-dp__dow"
  }, d)), Array.from({
    length: 42
  }).map((_, i) => {
    const d = new Date(gridStart.getFullYear(), gridStart.getMonth(), gridStart.getDate() + i);
    ...
    className: "twc-dp__months"
  }, MONTHS.map((name, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
...
function Divider({
  ...
  if (children) {
    return /*#__PURE__*/React.createElement("div", _extends({
      className: `twc-divider-label ${className}`,
      "data-align": align,
      role: "separator"
    }, rest), children);
  }
...
function Drawer({
  ...
  if (!open) return null;
  const sizeVar = side === "left" || side === "right" ? {
    "--_w": typeof size === "number" ? `${size}px` : size
  } : {
    "--_h": typeof size === "number" ? `${size}px` : size
  };
  return /*#__PURE__*/React.createElement("div", {
    className: "twc-drawer__overlay",
    onMouseDown: e => {
      if (closeOnBackdrop && e.target === e.currentTarget) onClose?.();
    }
  }, /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-drawer ${className}`,
    "data-side": side,
    role: "dialog",
    "aria-modal": "true",
    style: size ? sizeVar : undefined
  }, rest), title || description || onClose ? /*#__PURE__*/React.createElement("div", {
    className: "twc-drawer__header"
  }, /*#__PURE__*/React.createElement("div", {
    className: "twc-drawer__titles"
  }, title ? /*#__PURE__*/React.createElement("div", {
    className: "twc-drawer__title"
  }, title) : null, description ? /*#__PURE__*/React.createElement("div", {
    className: "twc-drawer__desc"
  }, description) : null), onClose ? /*#__PURE__*/React.createElement("button", {
    className: "twc-drawer__close",
    onClick: onClose,
    "aria-label": "Close",
    type: "button"
  }, /*#__PURE__*/React.createElement("svg", {
    ...
    className: "twc-drawer__body"
  }, children), footer ? /*#__PURE__*/React.createElement("div", {
    className: "twc-drawer__footer"
  }, footer) : null));
}
...
function EmptyState({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-empty ${className}`,
    "data-bordered": bordered || undefined
  }, rest), icon ? /*#__PURE__*/React.createElement("span", {
    className: "twc-empty__icon",
    "aria-hidden": "true"
  }, icon) : null, title ? /*#__PURE__*/React.createElement("div", {
    className: "twc-empty__title"
  }, title) : null, description ? /*#__PURE__*/React.createElement("div", {
    className: "twc-empty__desc"
  }, description) : null, actions ? /*#__PURE__*/React.createElement("div", {
    className: "twc-empty__actions"
  }, actions) : null);
}
...
function Alert({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-alert ${className}`,
    "data-tone": tone,
    role: "alert"
  }, rest), /*#__PURE__*/React.createElement("span", {
    className: "twc-alert__icon",
    "aria-hidden": "true"
    ...
    className: "twc-alert__body"
  }, title ? /*#__PURE__*/React.createElement("div", {
    className: "twc-alert__title"
  }, title) : null, children ? /*#__PURE__*/React.createElement("div", {
    className: "twc-alert__desc"
  }, children) : null), onClose ? /*#__PURE__*/React.createElement("button", {
    className: "twc-alert__close",
    onClick: onClose,
    "aria-label": "Dismiss",
    type: "button"
  }, /*#__PURE__*/React.createElement("svg", {
...
`;
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: `twc-progress-wrap ${className}`
  }, showLabel && !indeterminate ? /*#__PURE__*/React.createElement("div", {
    className: "twc-progress__meta"
  }, /*#__PURE__*/React.createElement("span", null, "Progress"), /*#__PURE__*/React.createElement("span", null, Math.round(pct), "%")) : null, /*#__PURE__*/React.createElement("div", _extends({
...
`;
  ...
  if (variant === "text" && lines > 1) {
    return /*#__PURE__*/React.createElement("div", _extends({
      className: `twc-skeleton__group ${className}`
    }, rest), Array.from({
      length: lines
    }).map((_, i) => /*#__PURE__*/React.createElement("span", {
      key: i,
      className: "twc-skeleton",
      "data-variant": "text",
      style: {
        width: width || "100%"
      }
...
`;
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    className: `twc-spinner ${className}`,
    "data-size": size,
    "data-tone": tone,
    role: "status",
    "aria-label": label
...
function Toast({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    d: TOAST_ICONS[tone] || TOAST_ICONS.default
  }))), /*#__PURE__*/React.createElement("div", {
    className: "twc-toast__body"
  }, title ? /*#__PURE__*/React.createElement("div", {
    className: "twc-toast__title"
  }, title) : null, children ? /*#__PURE__*/React.createElement("div", {
    className: "twc-toast__desc"
  }, children) : null), onClose ? /*#__PURE__*/React.createElement("button", {
    className: "twc-toast__close",
    onClick: onClose,
    "aria-label": "Dismiss",
    type: "button"
  }, /*#__PURE__*/React.createElement("svg", {
...
function ToastViewport({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-toast-viewport ${className}`
  }, rest), children);
}
...
function FileUpload({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-upload ${className}`
  }, rest), /*#__PURE__*/React.createElement("div", {
    ...
    className: "twc-upload__title"
  }, /*#__PURE__*/React.createElement("em", null, "Click to upload"), " or drag and drop"), /*#__PURE__*/React.createElement("span", {
    className: "twc-upload__hint"
  }, hint || (accept ? accept.replace(/\./g, "").toUpperCase() : "Any file")), /*#__PURE__*/React.createElement("input", {
    ref: inputRef,
    ...
    className: "twc-upload__list"
  }, files.map((f, i) => /*#__PURE__*/React.createElement("div", {
    className: "twc-upload__file",
    key: i
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-upload__file-ic",
    "aria-hidden": "true"
  }, /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
    ...
    className: "twc-upload__file-main"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-upload__file-name"
  }, f.name), /*#__PURE__*/React.createElement("span", {
    className: "twc-upload__file-size"
  }, fmtSize(f.size))), /*#__PURE__*/React.createElement("button", {
    className: "twc-upload__file-x",
...
function useCurStyles() {
  React.useEffect(() => {
    ...
    const el = document.createElement("style");
    el.id = "twc-cur-styles";
    el.textContent = CUR_CSS;
    document.head.appendChild(el);
  }, []);
}
...
function Currency({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "twc-field__label",
    htmlFor: fieldId
  }, label, required ? /*#__PURE__*/React.createElement("span", {
    className: "twc-field__req"
  }, "*") : null) : null, /*#__PURE__*/React.createElement("div", {
    className: "twc-cur",
    "data-size": size,
    ...
    className: "twc-cur__sym",
    "aria-hidden": "true"
  }, sym), /*#__PURE__*/React.createElement("input", _extends({
    id: fieldId,
    ...
    className: "twc-cur__code"
  }, cur)), error ? /*#__PURE__*/React.createElement("span", {
    className: "twc-field__error"
  }, error) : hint ? /*#__PURE__*/React.createElement("span", {
    className: "twc-field__hint"
  }, hint) : null);
}
Object.assign(__ds_scope, { CURRENCIES, CURRENCY_OPTIONS, clampPrecision, Currency });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/inputs/Currency.jsx", error: String((e && e.message) || e) }); }
...
function Input({
  ...
  const suffix = rightIcon ? /*#__PURE__*/React.createElement("span", {
    className: "twc-input__affix"
  }, rightIcon) : isPassword ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    ...
    tabIndex: disabled ? -1 : 0
  }, revealed ? /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    strokeWidth: "2",
...
function Kanban({
  ...
  const move = (cardId, toCol) => {
    ...
    const next = items.map(c => c.id === cardId ? {
      ...c,
      column: toCol
    } : c);
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-kanban ${className}`
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "twc-kanban__col-h"
    }, /*#__PURE__*/React.createElement("span", {
      className: "twc-kanban__dot",
      style: col.color ? {
        "--_c": col.color
      } : undefined
    }), /*#__PURE__*/React.createElement("span", {
      className: "twc-kanban__col-title"
    }, col.title), /*#__PURE__*/React.createElement("span", {
      className: "twc-kanban__count"
    }, colCards.length)), /*#__PURE__*/React.createElement("div", {
      className: "twc-kanban__list"
    }, colCards.map(card => /*#__PURE__*/React.createElement("div", {
      key: card.id,
      className: "twc-kanban__card",
      draggable: true,
      "data-dragging": drag === card.id || undefined,
      onDragStart: e => {
        setDrag(card.id);
    ...
    }, renderCard ? renderCard(card) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      className: "twc-kanban__card-title"
    }, card.title), card.description ? /*#__PURE__*/React.createElement("div", {
      className: "twc-kanban__card-desc"
    }, card.description) : null, card.tags?.length || card.footer ? /*#__PURE__*/React.createElement("div", {
      className: "twc-kanban__card-foot"
    }, /*#__PURE__*/React.createElement("span", {
      className: "twc-kanban__tags"
    }, (card.tags || []).map((t, i) => /*#__PURE__*/React.createElement("span", {
      key: i,
      className: "twc-kanban__tag"
    }, t))), card.footer || null) : null)))));
  }));
}
...
function List({
  ...
  return /*#__PURE__*/React.createElement("ul", _extends({
    className: `twc-list ${className}`,
    "data-plain": plain || undefined
  }, rest), items.map((it, i) => {
    const interactive = Boolean(it.onClick || it.href);
    const Tag = it.href ? "a" : interactive ? "button" : "div";
    const content = /*#__PURE__*/React.createElement(React.Fragment, null, it.leading ? /*#__PURE__*/React.createElement("span", {
      className: "twc-list__lead",
      "aria-hidden": "true"
    }, it.leading) : null, /*#__PURE__*/React.createElement("span", {
      className: "twc-list__main"
    }, /*#__PURE__*/React.createElement("span", {
      className: "twc-list__title"
    }, it.title), it.description ? /*#__PURE__*/React.createElement("span", {
      className: "twc-list__desc"
    }, it.description) : null), it.trailing ? /*#__PURE__*/React.createElement("span", {
      className: "twc-list__trail"
    }, it.trailing) : null);
...
function Navbar({
  ...
  return /*#__PURE__*/React.createElement("header", _extends({
    className: `twc-navbar ${className}`,
    "data-sticky": sticky || undefined
  }, rest), brand ? /*#__PURE__*/React.createElement("a", {
    className: "twc-navbar__brand",
    href: "#"
  }, brand) : null, /*#__PURE__*/React.createElement("nav", {
    className: "twc-navbar__links"
    ...
    onClick: l.onClick
  }, l.icon, l.label))), /*#__PURE__*/React.createElement("span", {
    className: "twc-navbar__spacer"
  }), actions ? /*#__PURE__*/React.createElement("div", {
    className: "twc-navbar__actions"
  }, actions) : null);
}
...
function Accordion({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-accordion ${className}`
  }, rest), items.map(it => {
    const isOpen = open.has(it.value);
    return /*#__PURE__*/React.createElement("div", {
      className: "twc-accordion__item",
      key: it.value
    }, /*#__PURE__*/React.createElement("button", {
      className: "twc-accordion__trigger",
      "data-open": isOpen || undefined,
      "aria-expanded": isOpen,
      onClick: () => toggle(it.value)
    }, it.icon, /*#__PURE__*/React.createElement("span", {
      className: "twc-accordion__label"
    }, it.label), /*#__PURE__*/React.createElement("span", {
      className: "twc-accordion__chevron",
      "aria-hidden": "true"
    }, /*#__PURE__*/React.createElement("svg", {
      viewBox: "0 0 24 24",
      fill: "none",
      ...
      className: "twc-accordion__panel",
      "data-open": isOpen || undefined
    }, /*#__PURE__*/React.createElement("div", {
      className: "twc-accordion__panel-inner"
    }, /*#__PURE__*/React.createElement("div", {
      className: "twc-accordion__content"
    }, it.content))));
  }));
}
...
function Tabs({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-tabs ${className}`,
    "data-variant": variant
  }, rest), /*#__PURE__*/React.createElement("div", {
    className: "twc-tabs__list",
    ref: listRef,
    role: "tablist"
...
function Dialog({
  ...
  if (!open) return null;
  return /*#__PURE__*/React.createElement("div", {
    className: "twc-dialog__overlay",
    onMouseDown: e => {
      if (closeOnBackdrop && e.target === e.currentTarget) onClose?.();
    }
  }, /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-dialog ${className}`,
    "data-size": size,
    role: "dialog",
    "aria-modal": "true"
  }, rest), title || description ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dialog__header"
  }, /*#__PURE__*/React.createElement("div", {
    className: "twc-dialog__titles"
  }, title ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dialog__title"
  }, title) : null, description ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dialog__desc"
  }, description) : null), onClose ? /*#__PURE__*/React.createElement("button", {
    className: "twc-dialog__close",
    onClick: onClose,
    "aria-label": "Close",
    type: "button"
  }, /*#__PURE__*/React.createElement("svg", {
    ...
    className: "twc-dialog__body"
  }, children) : null, footer ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dialog__footer"
  }, footer) : null));
}
...
function Menu({
  ...
  const RD = {
    createPortal: typeof createPortal === "function" ? createPortal : typeof window !== "undefined" && window.ReactDOM && window.ReactDOM.createPortal
  };
  ...
  const menu = open && pos ? /*#__PURE__*/React.createElement("div", {
    className: "twc-menu",
    ref: menuRef,
    "data-align": align,
    ...
    className: "twc-menu__header"
  }, header) : null, items.map((it, i) => {
    if (it.separator) return /*#__PURE__*/React.createElement("div", {
      key: `s${i}`,
      className: "twc-menu__sep",
      role: "separator"
    });
    if (it.label && it.heading) return /*#__PURE__*/React.createElement("div", {
      key: `h${i}`,
      className: "twc-menu__label"
    }, it.label);
    return /*#__PURE__*/React.createElement("button", {
      key: i,
      ...
      className: "twc-menu__item-label"
    }, it.label), it.shortcut ? /*#__PURE__*/React.createElement("span", {
      className: "twc-menu__shortcut"
    }, it.shortcut) : null);
  })) : null;
  return /*#__PURE__*/React.createElement("span", _extends({
    className: `twc-menu-wrap ${className}`,
    ref: wrapRef,
    onKeyDown: onKeyDown
  }, rest), /*#__PURE__*/React.createElement("span", {
    onClick: toggle
  }, trigger), menu && RD && RD.createPortal ? RD.createPortal(menu, document.body) : menu);
}
Object.assign(__ds_scope, { Menu });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/overlay/Menu.jsx", error: String((e && e.message) || e) }); }

// components/data-display/AvatarMenu.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
...
function AvatarMenu({
  ...
  const header = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(__ds_scope.Avatar, {
    name: name,
    src: src,
    size: "md",
    status: status
  }), /*#__PURE__*/React.createElement("span", {
    className: "twc-menu__header-main"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-menu__header-title"
  }, name), sub ? /*#__PURE__*/React.createElement("span", {
    className: "twc-menu__header-sub"
  }, sub) : null));
  const trigger = /*#__PURE__*/React.createElement("span", {
    ...
    className: "twc-avatar-menu__text"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-avatar-menu__name"
  }, name), sub ? /*#__PURE__*/React.createElement("span", {
    className: "twc-avatar-menu__sub"
  }, sub) : null) : null, showChev ? /*#__PURE__*/React.createElement("span", {
    className: "twc-avatar-menu__chev",
    "aria-hidden": "true"
  }, /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/data-display/AvatarMenu.jsx", error: String((e && e.message) || e) }); }
...
function Popover({
  ...
  const place = React.useCallback(() => {
    ...
    if (vertical) {
      ...
      left = l;
      arrow = {
        left: Math.min(Math.max(r.left + r.width / 2 - l - 5.5, 10), w - 20),
        [flip ? "bottom" : "top"]: -6
      };
      return setPos({
        top,
  ...
  const pop = open && pos ? /*#__PURE__*/React.createElement("div", {
    ...
    className: "twc-popover__arrow",
    style: pos.arrow,
    "aria-hidden": "true"
  }), /*#__PURE__*/React.createElement("div", {
    className: "twc-popover__inner"
  }, title ? /*#__PURE__*/React.createElement("div", {
    className: "twc-popover__title"
  }, title) : null, children)) : null;
  return /*#__PURE__*/React.createElement("span", _extends({
    className: `twc-popover-wrap ${className}`,
    ref: wrapRef
  }, rest), /*#__PURE__*/React.createElement("span", {
    onClick: () => setOpen(o => !o)
...
function ensureVisible(list, el) {
  ...
  if (top < list.scrollTop) list.scrollTop = top - 4;else if (bottom > list.scrollTop + list.clientHeight) list.scrollTop = bottom - list.clientHeight + 4;
}
function Combobox({
  label,
  hint,
  ...
  const fGroups = React.useMemo(() => groups.map(g => ({
    group: g.group,
    options: g.options.filter(o => matches(o, query.trim()))
  })).filter(g => g.options.length), [groups, query]);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onKeyDown: onKeyDown
  }, rest)), clearable && selected && !open ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "twc-cb__clear",
    "aria-label": "Clear",
    onClick: e => {
      e.stopPropagation();
      commit(null);
    ...
    className: "twc-pop__empty"
  }, "No results found") : fGroups.map((g, gi) => /*#__PURE__*/React.createElement(React.Fragment, {
    key: gi
  }, g.group ? /*#__PURE__*/React.createElement("div", {
    className: "twc-pop__group"
  }, g.group) : null, g.options.map(o => {
    counter += 1;
    const idx = counter;
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: "twc-opt__main"
    }, /*#__PURE__*/React.createElement("span", {
      className: "twc-opt__label"
    }, o.label), o.description ? /*#__PURE__*/React.createElement("span", {
      className: "twc-opt__desc"
    }, o.description) : null), isSel ? /*#__PURE__*/React.createElement("span", {
      className: "twc-opt__check",
      "aria-hidden": "true"
    }, /*#__PURE__*/React.createElement("svg", {
      viewBox: "0 0 24 24",
      fill: "none",
...
function MultiSelect({
  ...
  function onKeyDown(e) {
    if (e.key === "ArrowDown") {
      e.preventDefault();
      if (!open) setOpen(true);else setActive(a => Math.min(a + 1, visible.length - 1));
    } else if (e.key === "ArrowUp") {
      e.preventDefault();
      setActive(a => Math.max(a - 1, 0));
    } else if (e.key === "Enter") {
  ...
  }, selectedOpts.map(o => /*#__PURE__*/React.createElement("span", {
    className: "twc-ms__chip",
    key: o.value
  }, o.label, /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "twc-ms__chip-x",
...
function Select({
  ...
  const fGroups = React.useMemo(() => {
    ...
    return groups.map(g => ({
      group: g.group,
      options: g.options.filter(o => o.label.toLowerCase().includes(q) || o.description && o.description.toLowerCase().includes(q))
  ...
  const place = React.useCallback(() => {
    ...
    setCoords({
      ...
      bottom: flip ? Math.round(vh - r.top + 6) : undefined,
      flip
    });
  }, [placement, minWidth]);
  React.useEffect(() => {
  ...
  function onKeyDown(e) {
    ...
    if (!open) return;
    if (e.key === "Escape") setOpen(false);else if (e.key === "ArrowDown") {
      e.preventDefault();
      setActive(a => Math.min(a + 1, visible.length - 1));
    } else if (e.key === "ArrowUp") {
      e.preventDefault();
  ...
  let counter = -1;
  const popInner = /*#__PURE__*/React.createElement(React.Fragment, null, showSearch ? /*#__PURE__*/React.createElement("div", {
    className: "twc-pop__search"
  }, /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
  ...
  if (open) {
    if (canPortal && coords) {
      popEl = RD.createPortal(/*#__PURE__*/React.createElement("div", {
      ...
      }, popInner), document.body);
    } else if (!portal) {
      popEl = /*#__PURE__*/React.createElement("div", {
        className: "twc-pop",
        role: "listbox",
        ref: popRef,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    d: "m6 9 6 6 6-6"
  })))), popEl), error ? /*#__PURE__*/React.createElement("span", {
    className: "twc-field__error"
  }, error) : hint ? /*#__PURE__*/React.createElement("span", {
    className: "twc-field__hint"
  }, hint) : null);
...
function useCurfStyles() {
  React.useEffect(() => {
    ...
    const el = document.createElement("style");
    el.id = "twc-curf-styles";
    el.textContent = CURF_CSS;
    document.head.appendChild(el);
  }, []);
}
...
function CurrencyField({
  ...
  const meta = __ds_scope.CURRENCIES[cur] || __ds_scope.CURRENCIES.USD;
  const prec = meta.precision;
  const valControlled = value !== undefined;
  const [valInternal, setValInternal] = React.useState(() => __ds_scope.clampPrecision(String(defaultValue ?? ""), prec));
  const shown = valControlled ? __ds_scope.clampPrecision(String(value ?? ""), prec) : valInternal;
  const options = React.useMemo(() => {
    if (!currencies) return __ds_scope.CURRENCY_OPTIONS;
    return currencies.map(c => typeof c === "string" ? {
      value: c,
      label: `${c} — ${(__ds_scope.CURRENCIES[c] || {}).label || c}`
    } : c);
  }, [currencies]);
  function setCurrency(next) {
    ...
    const reclamped = __ds_scope.clampPrecision(shown, (__ds_scope.CURRENCIES[next] || __ds_scope.CURRENCIES.USD).precision);
    if (!valControlled) setValInternal(reclamped);
  }
  function handleChange(e) {
    const next = __ds_scope.clampPrecision(e.target.value, prec);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "twc-cur__sym",
    "aria-hidden": "true"
  }, meta.symbol), /*#__PURE__*/React.createElement("input", _extends({
    id: fieldId,
    className: "twc-cur__el",
    inputMode: "decimal",
    type: "text",
    ...
    className: "twc-cur__code"
  }, meta.code)), error ? /*#__PURE__*/React.createElement("span", {
    className: "twc-field__error"
  }, error) : hint ? /*#__PURE__*/React.createElement("span", {
    className: "twc-field__hint"
  }, hint) : null);
...
function Sidebar({
  ...
  return /*#__PURE__*/React.createElement("aside", _extends({
    className: `twc-sidebar ${className}`,
    "data-collapsed": collapsed || undefined
  }, rest), brand ? /*#__PURE__*/React.createElement("div", {
    className: "twc-sidebar__head"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-sidebar__brand"
  }, brand)) : null, /*#__PURE__*/React.createElement("nav", {
    className: "twc-sidebar__nav"
  }, items.map((it, i) => it.section ? /*#__PURE__*/React.createElement("div", {
    key: i,
    className: "twc-sidebar__section"
    ...
    className: "twc-sidebar__ic",
    "aria-hidden": "true"
  }, it.icon) : null, /*#__PURE__*/React.createElement("span", {
    className: "twc-sidebar__label"
  }, it.label), it.badge != null ? /*#__PURE__*/React.createElement("span", {
    className: "twc-sidebar__badge"
  }, it.badge) : null))), footer || collapsible ? /*#__PURE__*/React.createElement("div", {
    className: "twc-sidebar__foot"
  }, footer ? /*#__PURE__*/React.createElement("div", {
    className: "twc-sidebar__foot-user"
  }, footer) : null, collapsible ? /*#__PURE__*/React.createElement("button", {
    className: "twc-sidebar__collapse",
    onClick: toggle,
...
function Slider({
  ...
  function onKeyDown(e) {
    if (disabled) return;
    let next = val;
    if (e.key === "ArrowRight" || e.key === "ArrowUp") next = clampSnap(val + step);else if (e.key === "ArrowLeft" || e.key === "ArrowDown") next = clampSnap(val - step);else if (e.key === "Home") next = min;else if (e.key === "End") next = max;else return;
    e.preventDefault();
    setVal(next);
  }
  const ticks = showTicks ? Math.floor((max - min) / step) + 1 : 0;
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-slider ${className}`,
    "data-disabled": disabled || undefined
  }, rest), label || showValue ? /*#__PURE__*/React.createElement("div", {
    className: "twc-slider__head"
  }, label ? /*#__PURE__*/React.createElement("label", {
    className: "twc-slider__label",
    htmlFor: fieldId
  }, label) : /*#__PURE__*/React.createElement("span", null), showValue ? /*#__PURE__*/React.createElement("span", {
    className: "twc-slider__value"
  }, fmt(val)) : null) : null, /*#__PURE__*/React.createElement("div", {
    className: "twc-slider__track",
    ref: trackRef,
    "data-show-bubble": dragging || undefined,
    onPointerDown: onPointerDown
  }, /*#__PURE__*/React.createElement("div", {
    className: "twc-slider__rail"
  }), /*#__PURE__*/React.createElement("div", {
    className: "twc-slider__fill",
    style: {
      width: `${pct}%`
    }
  }), showTicks ? /*#__PURE__*/React.createElement("div", {
    className: "twc-slider__ticks"
  }, Array.from({
    length: ticks
  }).map((_, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    className: "twc-slider__tick",
    style: {
      left: `${i / (ticks - 1) * 100}%`
    }
  }))) : null, /*#__PURE__*/React.createElement("div", {
...
function Stat({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-stat ${className}`,
    "data-plain": plain || undefined
  }, rest), /*#__PURE__*/React.createElement("div", {
    className: "twc-stat__top"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-stat__label"
  }, label), icon ? /*#__PURE__*/React.createElement("span", {
    className: "twc-stat__icon",
    "aria-hidden": "true"
  }, icon) : null), /*#__PURE__*/React.createElement("div", {
    className: "twc-stat__value"
  }, value), delta != null || helpText ? /*#__PURE__*/React.createElement("div", {
    className: "twc-stat__foot"
  }, delta != null ? /*#__PURE__*/React.createElement("span", {
    className: "twc-stat__delta",
    "data-dir": dir
  }, /*#__PURE__*/React.createElement(Arrow, {
    dir: dir
  }), delta) : null, helpText ? /*#__PURE__*/React.createElement("span", {
    className: "twc-stat__help"
  }, helpText) : null) : null);
}
...
const BangIcon = () => /*#__PURE__*/React.createElement("svg", {
  viewBox: "0 0 24 24",
  fill: "none",
  stroke: "currentColor",
  strokeWidth: "3",
...
function Stepper({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-stepper ${className}`,
    "data-orientation": orientation
    ...
    const indicator = /*#__PURE__*/React.createElement("span", {
      className: "twc-step__indicator",
      "aria-hidden": "true"
    }, state === "complete" ? /*#__PURE__*/React.createElement(CheckIcon, null) : state === "error" ? /*#__PURE__*/React.createElement(BangIcon, null) : step.icon || i + 1);
    if (orientation === "vertical") {
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "twc-step__col"
      }, indicator, !last ? /*#__PURE__*/React.createElement("span", {
        className: "twc-step__connector"
      }) : null), /*#__PURE__*/React.createElement("div", {
        className: "twc-step__body twc-step__vbody"
      }, /*#__PURE__*/React.createElement("span", {
        className: "twc-step__title"
      }, step.title), step.description ? /*#__PURE__*/React.createElement("span", {
        className: "twc-step__desc"
...
function buildPages(current, total, siblings = 1, boundaries = 1) {
  ...
  for (const p of valid) {
    if (p - prev === 2) out.push(prev + 1);else if (p - prev > 2) out.push("…");
    out.push(p);
    prev = p;
  }
  return out;
...
function Pagination({
  ...
  return /*#__PURE__*/React.createElement("nav", _extends({
    className: `twc-pagination ${className}`,
    ...
    key: `e${i}`,
    className: "twc-page twc-page__ellipsis",
    "aria-hidden": "true"
  }, "\u2026") : /*#__PURE__*/React.createElement("button", {
    key: p,
    className: "twc-page",
    ...
    d: "m9 18 6-6-6-6"
  }))), showJumper && total > 1 ? /*#__PURE__*/React.createElement("span", {
    className: "twc-pagination__jump",
    "data-size": size
  }, jumperLabel, /*#__PURE__*/React.createElement("input", {
    type: "number",
    min: 1,
    max: total,
    value: jump,
...
function Svg({
  ...
  return /*#__PURE__*/React.createElement("svg", _extends({
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round"
  }, p), d.split("M").filter(Boolean).map((seg, i) => /*#__PURE__*/React.createElement("path", {
    key: i,
    d: "M" + seg
  })));
}
...
function useFloating() {
  ...
  const open = (el, align = "left", width = 220) => {
    ...
    setPos({
      ...
      maxHeight: Math.max(180, vh - top - M)
    });
  };
...
function EditCell({
  ...
  if (isSelect) {
    const opts = options || (col.valueOptions || []).map(o => typeof o === "string" ? {
      value: o,
      label: o
    } : o);
    return /*#__PURE__*/React.createElement("div", {
...
function Datatable({
  ...
  const [pins, setPins] = React.useState(() => {
    const left = [],
      right = [];
    columns.forEach(c => {
      if (c.pinned === "left") left.push(c.field);else if (c.pinned === "right") right.push(c.field);
    });
    return {
      left,
      right
  ...
  const displayItems = React.useMemo(() => {
    ...
    const build = (rowsIn, depth, prefix) => {
      if (depth >= activeGroupBy.length) return rowsIn.map(row => ({
        kind: "leaf",
        row
      }));
  ...
  function pinRow(key, side) {
    setPinnedRows(p => {
      const top = p.top.filter(k => k !== key),
        bottom = p.bottom.filter(k => k !== key);
  ...
  function addFilter(field) {
    ...
    setFilters(f => [...f, {
      ...
      field: col.field,
      op: opsFor(col.type)[0].value,
      value: ""
    }]);
  }
  function setPin(field, side) {
    setPins(p => {
      const left = p.left.filter(f => f !== field),
        right = p.right.filter(f => f !== field);
  ...
  function optionsForField(field) {
    ...
    if (col?.valueOptions) return col.valueOptions.map(o => typeof o === "string" ? {
      value: o,
      label: o
    } : o);
    const set = new Set();
    ...
    return [...set].sort((a, b) => a.localeCompare(b)).map(v => ({
      value: v,
      label: v
    }));
  }
  ...
  function toggleAll() {
    setSelected(s => {
      const n = new Set(s);
      if (allSel) paged.forEach(r => n.delete(keyOf(r)));else paged.forEach(r => n.add(keyOf(r)));
      return n;
    });
  }
  ...
  function onGridKeyDown(e) {
    ...
    if (!td) return;
    let r = +td.getAttribute("data-r"),
      c = +td.getAttribute("data-c");
    const maxR = leafRows.length - 1,
      maxC = ordered.length - 1;
    let handled = true;
    switch (e.key) {
      case "ArrowDown":
        r = Math.min(r + 1, maxR);
      ...
      case " ":
        {
          ...
          if (selectionMode === "cell") {
            ...
            handleCellClick({
              target: td
            }, keyOf(leafRows[r], r), leafRows[r], ordered[c]);
            return;
          }
          if (selectionMode === "row") {
            e.preventDefault();
  ...
  React.useEffect(() => {
    setFocus(f => ({
      r: Math.min(f.r, Math.max(0, leafRows.length - 1)),
      c: Math.min(f.c, Math.max(0, ordered.length - 1))
    }));
  ...
  const batchEditableCols = React.useMemo(() => cols.filter(c => c.type !== "actions" && (c.editable ?? (editMode && c.editable !== false))), [cols, editMode]);
  ...
  function renderActions(col, row) {
    ...
    const pinItems = canPinRows ? (() => {
      ...
      return [{
        label: side === "top" ? "Unpin from top" : "Pin to top",
        icon: /*#__PURE__*/React.createElement(Svg, {
          d: I.pinUp
        }),
        showInMenu: true,
        onClick: () => pinRow(key, side === "top" ? null : "top")
      }, {
        label: side === "bottom" ? "Unpin from bottom" : "Pin to bottom",
        icon: /*#__PURE__*/React.createElement(Svg, {
          d: I.pinDown
        }),
        showInMenu: true,
        onClick: () => pinRow(key, side === "bottom" ? null : "bottom")
      }];
    })() : [];
    const menu = [...items.filter(a => a.showInMenu), ...pinItems];
    return /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__actions",
      style: {
        justifyContent: col.align === "right" ? "flex-end" : "flex-start"
      }
    }, inline.map((a, i) => /*#__PURE__*/React.createElement("button", {
      key: i,
    ...
    }, a.icon)), menu.length ? /*#__PURE__*/React.createElement("button", {
      className: "twc-dt__act",
  ...
  const shownColRows = cols.filter(c => c.headerName.toLowerCase().includes(colQuery.trim().toLowerCase())).sort((a, b) => orderIdxOf(a.field) - orderIdxOf(b.field));
  const rppOptions = Array.from(new Set([...(pageSizeOptions || []), pageSize].filter(n => n > 0))).sort((a, b) => a - b).map(n => ({
    value: String(n),
    label: String(n)
  }));
  ...
  function renderGroupRow(item) {
    ...
    return /*#__PURE__*/React.createElement("tr", {
      key: `g${item.key}`,
      className: "twc-dt__group-row",
      role: "row"
    }, /*#__PURE__*/React.createElement("td", {
      className: "twc-dt__group-cell",
      role: "gridcell",
      colSpan: totalCols,
      style: {
        maxWidth: "none"
      ...
      className: "twc-dt__group-chev",
      "data-open": !item.collapsed || undefined
    }, /*#__PURE__*/React.createElement(Svg, {
      d: I.chevDown
    })), /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__group-name"
    }, colByField[item.field]?.headerName || item.field, ":"), /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__group-val"
    }, String(item.value)), /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__group-count"
    }, item.count)), subs.length ? /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__group-sub"
    }, subs.map((s, i) => /*#__PURE__*/React.createElement("span", {
      key: i
    }, s))) : null));
  }
  function renderLeaf(row, ri, pinSide) {
    ...
    return /*#__PURE__*/React.createElement("tr", {
      ...
      onDragOver: reorderable && rowDrag.from != null ? e => {
        ...
        setRowDrag(d => d.over === k && d.after === after ? d : {
          ...d,
          over: k,
          after
        });
      ...
      onDragEnd: reorderable ? () => setRowDrag({
        from: null,
        over: null,
        after: false
      }) : undefined,
      onClick: e => handleRowClick(e, k, row)
    }, checkboxSelection ? /*#__PURE__*/React.createElement("td", {
      className: "twc-dt__td",
      role: "gridcell",
      "data-pin": "left",
      "data-pin-edge": pins.left.length ? undefined : "left",
      style: {
        left: 0,
        width: 44
      }
      ...
      d: I.check
    })), rowResize && !pinSide ? /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__row-resizer",
      title: "Drag to resize row",
      onPointerDown: e => startRowResize(e, k, e.currentTarget.closest("tr")),
      onClick: e => e.stopPropagation()
    }) : null) : null, ordered.map((c, ci) => {
      ...
      return /*#__PURE__*/React.createElement("td", {
        ...
        "data-num": c.type === "number" || undefined,
        "data-actions": isActions || undefined,
        "data-editable": editable && !isEditing || undefined,
        ...
        title: isActions || c.renderCell || editable ? undefined : String(val ?? ""),
        onClick: selectionMode === "cell" ? e => handleCellClick(e, k, row, c) : undefined,
        onFocus: () => setFocus(f => f.r === ri && f.c === ci ? f : {
          r: ri,
          c: ci
        }),
        onDoubleClick: editable ? () => beginEdit(k, c, row) : undefined
      }, isEditing ? /*#__PURE__*/React.createElement(EditCell, {
        col: c,
        value: editing.value,
        ...
        onCancel: cancelEdit,
        onKeyDown: onEditKey
      }) : isActions ? renderActions(c, row) : c.renderCell ? c.renderCell(val, row) : c.valueFormatter ? c.valueFormatter(val, row) : val, editable && !isEditing ? /*#__PURE__*/React.createElement("span", {
        className: "twc-dt__edit-hint",
        "aria-hidden": "true"
      }, /*#__PURE__*/React.createElement(Svg, {
        d: I.pencil
      })) : null);
  ...
  function renderPivot() {
    const rFields = pivotConfig.rows,
      cFields = pivotConfig.columns || [],
      values = pivotConfig.values;
    const rowKeyOf = r => rFields.map(f => r[f] ?? "—").join("  ·  ");
    const colPathOf = r => cFields.map(f => String(r[f] ?? "—"));
    const aggOf = (subset, v) => computeAgg({
      field: v.field,
      aggregation: v.agg || "sum"
    }, subset || []);
    const fmt = (val, v) => {
      if (val == null) return "—";
    ...
    const headerLevels = cFields.map((_, lvl) => {
      ...
      while (i < leafPaths.length) {
        ...
        let span = 0;
        let j = i;
        while (j < leafPaths.length && leafPaths[j].slice(0, lvl + 1).join("\u0000") === prefix) {
          span++;
          j++;
        }
        cells.push({
    ...
    const ValueHead = ({
      ...
      className: "twc-dt__pivot-vh"
    }, /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__pivot-vh-label"
    }, vlabel(v)), /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__pivot-vh-agg"
    }, v.agg || "sum"));
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "twc-dt__table twc-dt__pivot",
      role: "grid",
      "aria-label": ariaLabel + " (pivot)"
    }, /*#__PURE__*/React.createElement("thead", null, cFields.map((cf, lvl) => /*#__PURE__*/React.createElement("tr", {
      role: "row",
      key: `lvl${lvl}`
    }, lvl === 0 ? /*#__PURE__*/React.createElement("th", {
      className: "twc-dt__th twc-dt__pivot-corner",
      "data-pin": "left",
      "data-pin-edge": "left",
      style: {
        left: 0
      ...
      className: "twc-dt__pivot-corner-label"
    }, rowFieldLabel)) : null, headerLevels[lvl].map(cell => /*#__PURE__*/React.createElement("th", {
      key: cell.key,
      className: "twc-dt__th twc-dt__pivot-colgroup",
      colSpan: cell.span,
      scope: "colgroup"
    }, cell.label)), lvl === 0 ? /*#__PURE__*/React.createElement("th", {
      className: "twc-dt__th twc-dt__pivot-total-h",
      colSpan: values.length,
      rowSpan: Math.max(cFields.length, 1),
      scope: "colgroup"
    }, "Total") : null)), /*#__PURE__*/React.createElement("tr", {
      role: "row"
    }, leafPaths.map(path => values.map((v, vi) => /*#__PURE__*/React.createElement("th", {
      key: leafKey(path) + v.field + (v.agg || ""),
      className: "twc-dt__th twc-dt__pivot-vhcell",
      "data-num": "true",
      "data-group-start": vi === 0 || undefined,
      scope: "col"
    }, /*#__PURE__*/React.createElement(ValueHead, {
      v: v
    })))), values.map((v, vi) => /*#__PURE__*/React.createElement("th", {
      key: "t" + v.field + (v.agg || ""),
      className: "twc-dt__th twc-dt__pivot-vhcell twc-dt__pivot-total-h",
      "data-num": "true",
      "data-group-start": vi === 0 || undefined,
      scope: "col"
    }, /*#__PURE__*/React.createElement(ValueHead, {
      v: v,
      total: true
    }))))), /*#__PURE__*/React.createElement("tbody", null, rowKeys.map((rk, rIdx) => {
      const subset = rowMap.get(rk);
      return /*#__PURE__*/React.createElement("tr", {
        key: rk,
        className: "twc-dt__row",
        role: "row",
        "data-zebra": rIdx % 2 === 1 || undefined
      }, /*#__PURE__*/React.createElement("th", {
        className: "twc-dt__td twc-dt__pivot-rowhead",
        scope: "row",
        "data-pin": "left",
        "data-pin-edge": "left",
        style: {
        ...
        className: "twc-dt__pivot-rowcount"
      }, "(", subset.length, ")")), leafPaths.map(path => {
        const cell = rowsForLeaf(subset, path);
        return values.map((v, vi) => {
          const val = cell.length ? aggOf(cell, v) : null;
          return /*#__PURE__*/React.createElement("td", {
            key: leafKey(path) + v.field,
            className: "twc-dt__td twc-dt__pivot-cell",
            role: "gridcell",
            "data-num": "true",
            "data-group-start": vi === 0 || undefined,
            "data-empty": val == null || undefined
          }, fmt(val, v));
        });
      }), values.map((v, vi) => /*#__PURE__*/React.createElement("td", {
        key: "t" + v.field,
        className: "twc-dt__td twc-dt__pivot-cell twc-dt__pivot-total",
        role: "gridcell",
        "data-num": "true",
        "data-group-start": vi === 0 || undefined
      }, fmt(aggOf(subset, v), v))));
    })), /*#__PURE__*/React.createElement("tfoot", null, /*#__PURE__*/React.createElement("tr", {
      role: "row"
    }, /*#__PURE__*/React.createElement("th", {
      className: "twc-dt__pivot-rowhead twc-dt__pivot-grand",
      "data-pin": "left",
      "data-pin-edge": "left",
      style: {
        left: 0
      ...
      scope: "row"
    }, "Total"), leafPaths.map(path => {
      const sub = rowsForLeaf(rows, path);
      return values.map((v, vi) => /*#__PURE__*/React.createElement("td", {
        key: leafKey(path) + v.field,
        "data-num": "true",
        "data-group-start": vi === 0 || undefined,
        className: "twc-dt__pivot-cell twc-dt__pivot-grand"
      }, fmt(sub.length ? aggOf(sub, v) : null, v)));
    }), values.map((v, vi) => /*#__PURE__*/React.createElement("td", {
      key: "t" + v.field,
      "data-num": "true",
      "data-group-start": vi === 0 || undefined,
      className: "twc-dt__pivot-cell twc-dt__pivot-grand twc-dt__pivot-total"
    }, fmt(aggOf(rows, v), v)))))));
  }
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-dt ${className}`,
    "data-density": density,
    "data-resizing": resizing || undefined
  }, rest), /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__toolbar"
  }, batchActions.length && selected.size > 0 ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__batch"
  }, /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__batch-x",
    onClick: clearSelection,
    "aria-label": "Clear selection"
  }, /*#__PURE__*/React.createElement(Svg, {
    d: I.x
  })), /*#__PURE__*/React.createElement("span", {
    className: "twc-dt__batch-count"
  }, selected.size, " selected"), /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__batch-actions"
  }, batchEditableCols.length ? /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__batch-btn",
    onClick: e => openBatchEditor(e.currentTarget)
  }, /*#__PURE__*/React.createElement(Svg, {
    d: I.pencil
  }), "Edit") : null, batchActions.map((a, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    className: "twc-dt__batch-btn",
    "data-danger": a.danger || undefined,
    disabled: a.disabled,
    onClick: () => a.onClick?.([...selected], selectedRows, clearSelection)
  }, a.icon, a.label)))) : null, /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__tbtn",
    "data-active": panel === "columns" || undefined,
    ...
    d: I.columns
  }), " Columns", hidden.size ? /*#__PURE__*/React.createElement("span", {
    className: "twc-dt__tbadge"
  }, cols.length - hidden.size) : null), /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__tbtn",
    "data-active": panel === "filters" || undefined,
    ...
    onClick: e => {
      if (panel === "filters") {
        ...
        setPanel("filters");
        setColMenu(null);
        openPanel(e.currentTarget, "left", 480);
      }
    }
  }, /*#__PURE__*/React.createElement(Svg, {
    d: I.filter
  }), " Filters", filters.length ? /*#__PURE__*/React.createElement("span", {
    className: "twc-dt__tbadge"
  }, filters.length) : null), /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__tbtn",
    "data-tip": "Change row density",
    onClick: () => setDensity(d => d === "compact" ? "standard" : d === "standard" ? "comfortable" : "compact")
  }, /*#__PURE__*/React.createElement(Svg, {
    d: I.density
  }), " ", density[0].toUpperCase() + density.slice(1)), /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__tbtn",
    "data-active": panel === "agg" || aggOn || undefined,
    "aria-haspopup": "dialog",
    ...
    d: I.sigma
  }), " Aggregation", aggOn && hasAggregation ? /*#__PURE__*/React.createElement("span", {
    className: "twc-dt__tbadge"
  }, ordered.filter(c => aggOf(c)).length) : null), /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__tbtn",
    "data-active": panel === "pivot" || pivotActive || undefined,
    "aria-haspopup": "dialog",
    ...
    d: I.pivot
  }), " Pivot", pivotActive ? /*#__PURE__*/React.createElement("span", {
    className: "twc-dt__tdot",
    "aria-label": "on",
    role: "img"
  }) : null), showExport ? /*#__PURE__*/React.createElement("span", {
    className: "twc-dt__export"
  }, /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__export-main",
  ...
  }))), !pivotActive && activeGroupBy.length ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__groupbar"
  }, /*#__PURE__*/React.createElement(Svg, {
    d: I.group
  }), /*#__PURE__*/React.createElement("span", {
    className: "twc-dt__groupbar-label"
  }, "Grouped by"), activeGroupBy.map(f => /*#__PURE__*/React.createElement("span", {
    key: f,
    className: "twc-dt__groupchip"
  }, colByField[f]?.headerName || f, /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__groupchip-x",
    "aria-label": `Stop grouping by ${colByField[f]?.headerName || f}`,
    onClick: () => toggleGroupField(f)
  }, /*#__PURE__*/React.createElement(Svg, {
    d: I.x
  })))), /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__groupbar-clear",
    onClick: () => setGroupBy([])
  }, "Clear all")) : null, pivotActive ? renderPivot() : /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__scroll",
    style: {
      maxHeight: height
    }
    ...
    role: "row",
    "aria-rowindex": 1
  }, checkboxSelection ? /*#__PURE__*/React.createElement("th", {
    ...
    className: "twc-dt__check",
    "data-checked": allSel || undefined,
    "data-indeterminate": !allSel && someSel || undefined,
    onClick: toggleAll,
    role: "checkbox",
    ...
    return /*#__PURE__*/React.createElement("th", {
      ...
      "data-num": c.type === "number" || undefined,
      "data-actions-col": c.type === "actions" || undefined,
      "data-sorted": sorted,
      "data-pin": st.pin,
      "data-pin-edge": st.edge,
      ...
      onDragOver: reorderable && drag.from ? e => {
        ...
        setDrag(d => d.over === c.field && d.after === after ? d : {
          ...d,
          over: c.field,
          after
        });
    ...
    }, reorderable ? /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__grip",
      "aria-hidden": "true"
    }, /*#__PURE__*/React.createElement(Svg, {
      d: I.grip
    })) : null, filteredFields.has(c.field) ? /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__filterdot"
    }) : null, c.headerName, c.sortable ? /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__sort"
    }, /*#__PURE__*/React.createElement(Svg, {
      d: I.arrow
    })) : null), hasMenu ? /*#__PURE__*/React.createElement("button", {
      ...
      d: I.more
    })) : null), resizable ? /*#__PURE__*/React.createElement("span", {
    ...
    length: paginated ? Math.min(rowsPerPage, 8) : 8
  }).map((_, ri) => /*#__PURE__*/React.createElement("tr", {
    key: ri,
    className: "twc-dt__row"
  }, checkboxSelection ? /*#__PURE__*/React.createElement("td", {
    className: "twc-dt__td",
    ...
    className: "twc-dt__sk",
    style: {
      "--_w": "18px",
      height: 18,
      borderRadius: 4
    }
  })) : null, ordered.map((c, ci) => {
    const st = stickyOf(c.field);
    return /*#__PURE__*/React.createElement("td", {
      key: c.field,
      className: "twc-dt__td",
      ...
      className: "twc-dt__sk",
      style: {
        "--_w": `${45 + (ri * 13 + ci * 29) % 45}%`
      }
    }));
  }))) : leafRows.length === 0 ? /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", {
    className: "twc-dt__td",
    colSpan: totalCols,
    style: {
      maxWidth: "none"
    ...
    className: "twc-dt__empty"
  }, "No rows match your filters"))) : displayItems ? (() => {
    let li = -1;
    return displayItems.map(item => item.kind === "group" ? renderGroupRow(item) : renderLeaf(item.row, ++li));
  })() : /*#__PURE__*/React.createElement(React.Fragment, null, pinnedTopRows.map(row => renderLeaf(row, keyIndex.get(keyOf(row)), "top")), middleRows.map(row => renderLeaf(row, keyIndex.get(keyOf(row)))), pinnedBottomRows.map(row => renderLeaf(row, keyIndex.get(keyOf(row)), "bottom")))), hasAggregation && aggOn && !loading && paged.length > 0 ? /*#__PURE__*/React.createElement("tfoot", null, /*#__PURE__*/React.createElement("tr", {
    role: "row"
  }, checkboxSelection ? /*#__PURE__*/React.createElement("td", {
    "data-pin": "left",
    "data-pin-edge": pins.left.length ? undefined : "left",
    ...
    }, v == null ? null : /*#__PURE__*/React.createElement(React.Fragment, null, typeof aggOf(c) === "string" ? /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__agg-label"
    }, aggLabels[aggOf(c)]) : null, /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__agg-val"
    }, display)));
  }))) : null)), !pivotActive ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__footer"
  }, /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__footer-row",
    "data-bottom": "true"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-dt__status"
  }, loading ? "Loading…" : (() => {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, paginated ? /*#__PURE__*/React.createElement(React.Fragment, null, "Showing ", /*#__PURE__*/React.createElement("b", null, nf(start), "\u2013", nf(end)), " of ", /*#__PURE__*/React.createElement("b", null, nf(totalRows)), " ", totalRows === 1 ? "row" : "rows") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("b", null, nf(totalRows)), " ", totalRows === 1 ? "row" : "rows"), selected.size ? /*#__PURE__*/React.createElement(React.Fragment, null, " \xB7 ", /*#__PURE__*/React.createElement("b", null, nf(selected.size)), " selected") : null);
  })()), paginated ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__rpp"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-dt__rpp-label"
  }, "Rows per page"), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 78
    }
  }, /*#__PURE__*/React.createElement(__ds_scope.Select, {
  ...
  }))) : null), paginated ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__footer-row",
    "data-pager": "true"
    ...
    total: totalPages,
    boundaries: 3,
    showJumper: showPageJumper && totalPages > 5,
    onChange: p => setPage(p - 1)
  })) : null) : null, exportOpen && exportPos ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__pop",
    style: {
      top: exportPos.top,
      left: exportPos.left,
      width: exportPos.width,
      maxHeight: exportPos.maxHeight,
      overflowY: "auto"
    }
    ...
    d: o.icon
  }), " ", o.label))) : null, batchEdit && batchEditPos ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__pop twc-dt__cfg",
    style: {
      top: batchEditPos.top,
      left: batchEditPos.left,
      width: 320
    }
  }, /*#__PURE__*/React.createElement(Caret, {
    pos: batchEditPos
  }), /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__cfg-head"
  }, "Edit ", selected.size, " selected ", selected.size === 1 ? "row" : "rows"), /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__cfg-list"
  }, batchEditableCols.map(c => {
    const on = !!batchEdit.fields[c.field];
    const opts = c.valueOptions ? c.valueOptions.map(o => typeof o === "string" ? {
      value: o,
      label: o
    } : o) : null;
    return /*#__PURE__*/React.createElement("div", {
      key: c.field,
      className: "twc-dt__be-row",
      "data-on": on || undefined
    }, /*#__PURE__*/React.createElement("label", {
      className: "twc-dt__be-check"
    }, /*#__PURE__*/React.createElement("input", {
      type: "checkbox",
      checked: on,
      onChange: e => setBatchEdit(b => ({
        ...b,
        fields: {
          ...b.fields,
    ...
    }), /*#__PURE__*/React.createElement("span", null, c.headerName)), /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__be-ctl"
    }, opts ? /*#__PURE__*/React.createElement(__ds_scope.Select, {
      size: "sm",
      portal: true,
      searchable: true,
    ...
    className: "twc-dt__cfg-foot"
  }, /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__cfg-btn",
    onClick: () => {
      setBatchEdit(null);
      closeBatchEdit();
    }
  ...
  }, "Apply to ", selected.size))) : null, colMenu && menuPos ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__pop",
    style: {
      top: menuPos.top,
      left: menuPos.left,
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, c.sortable ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
      className: "twc-dt__mi",
      "data-active": sort?.field === c.field && sort.dir === "asc" || undefined,
      onClick: () => {
        setSort({
          field: c.field,
          dir: "asc"
      ...
      d: I.arrow
    }), " Sort ascending"), /*#__PURE__*/React.createElement("button", {
      className: "twc-dt__mi",
      "data-active": sort?.field === c.field && sort.dir === "desc" || undefined,
      onClick: () => {
        setSort({
          field: c.field,
          dir: "desc"
    ...
    }), " Sort descending")) : null, c.filterable ? /*#__PURE__*/React.createElement("button", {
      className: "twc-dt__mi",
      onClick: e => {
        addFilter(c.field);
        setColMenu(null);
        closeMenu();
        setPanel("filters");
        openPanel(document.querySelector(".twc-dt__toolbar .twc-dt__tbtn:nth-child(2)"), "left", 480);
      }
    }, /*#__PURE__*/React.createElement(Svg, {
      d: I.filter
    }), " Filter") : null, hasTop && hasBottom ? /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__sep"
    }) : null, c.groupable ? /*#__PURE__*/React.createElement("button", {
      className: "twc-dt__mi",
      "data-active": groupBy.includes(c.field) || undefined,
      onClick: () => {
      ...
      d: I.group
    }), " ", groupBy.includes(c.field) ? "Stop grouping" : "Group by this column") : null, c.pinnable ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
      className: "twc-dt__mi",
      "data-active": pins.left.includes(c.field) || undefined,
      onClick: () => {
      ...
      d: I.pinL
    }), " ", pins.left.includes(c.field) ? "Unpin" : "Pin to left"), /*#__PURE__*/React.createElement("button", {
      className: "twc-dt__mi",
      "data-active": pins.right.includes(c.field) || undefined,
      onClick: () => {
      ...
      d: I.pin
    }), " ", pins.right.includes(c.field) ? "Unpin" : "Pin to right")) : null, c.hideable ? /*#__PURE__*/React.createElement("button", {
      className: "twc-dt__mi",
      onClick: () => {
  ...
  })()) : null, rowMenu && rowMenuPos ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__pop",
    style: {
      top: rowMenuPos.top,
      left: rowMenuPos.left,
      width: rowMenuPos.width,
      maxHeight: rowMenuPos.maxHeight,
      overflowY: "auto"
    }
  }, /*#__PURE__*/React.createElement(Caret, {
    pos: rowMenuPos
  }), rowMenu.items.map((a, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    className: "twc-dt__mi",
    disabled: a.disabled,
    style: a.danger ? {
  ...
  }, a.icon || null, a.label))) : null, panel === "columns" && panelPos ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__pop twc-dt__cols",
    style: {
      top: panelPos.top,
      left: panelPos.left
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__panel-head"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-dt__panel-title"
  }, "Columns"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__link",
    onClick: () => setHidden(new Set())
  }, "Show all"), /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__link",
    onClick: () => setHidden(new Set(cols.filter(c => c.hideable).map(c => c.field)))
  }, "Hide all"))), /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__col-search"
  }, /*#__PURE__*/React.createElement(Svg, {
    d: I.search
  }), /*#__PURE__*/React.createElement("input", {
    autoFocus: true,
    ...
    className: "twc-dt__col-list"
  }, shownColRows.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__empty",
    style: {
      padding: "18px 12px"
    }
  }, "No columns found") : shownColRows.map(c => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onClick: () => c.hideable && setHidden(h => {
        const n = new Set(h);
        n.has(c.field) ? n.delete(c.field) : n.add(c.field);
        return n;
      })
    }, canDrag ? /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__col-grip",
      "aria-hidden": "true"
    }, /*#__PURE__*/React.createElement(Svg, {
      d: I.grip
    })) : null, /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__col-name"
    }, c.headerName), /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__sw",
      "data-on": !hidden.has(c.field) || undefined,
      style: c.hideable ? undefined : {
        opacity: 0.4
      }
    }));
  }))) : null, panel === "agg" && panelPos ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__pop twc-dt__cfg",
    style: {
      top: panelPos.top,
      left: panelPos.left,
    ...
    role: "dialog",
    "aria-label": "Aggregation settings"
  }, /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__panel-head"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-dt__panel-title"
  }, "Aggregation"), /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__link",
    onClick: () => setAggConfig({})
  }, "Clear")), /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__cfg-toggle"
  }, /*#__PURE__*/React.createElement("span", null, "Show totals row"), /*#__PURE__*/React.createElement("span", {
    className: "twc-dt__sw",
    "data-on": aggOn || undefined,
    role: "switch",
    "aria-checked": aggOn,
    tabIndex: 0,
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__cfg-row",
      key: c.field
    }, /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__cfg-name"
    }, c.headerName), /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__cfg-ctl"
    }, /*#__PURE__*/React.createElement(__ds_scope.Select, {
      size: "sm",
      ...
      onChange: v => {
        setAggConfig(m => {
          ...
          if (!v) delete n[c.field];else n[c.field] = v;
          return n;
        });
        if (v) setAggOn(true);
      }
    })));
  }))) : null, panel === "pivot" && panelPos ? (() => {
    const fieldOpts = ordered.filter(c => c.type !== "actions").map(c => ({
      value: c.field,
      label: c.headerName
    }));
    const aggOpts = [{
    ...
    const valueFieldOpts = ordered.filter(c => c.type !== "actions" && !pivotConfig.values.some(v => v.field === c.field)).map(c => ({
      value: c.field,
      label: c.headerName
    }));
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "twc-dt__panel-title"
    }, "Pivot"), /*#__PURE__*/React.createElement("button", {
      className: "twc-dt__link",
      onClick: () => {
        setPivotConfig({
          rows: [],
      ...
      className: "twc-dt__cfg-toggle"
    }, /*#__PURE__*/React.createElement("span", null, "Pivot mode"), /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__sw",
      "data-on": pivotOn || undefined,
      role: "switch",
    ...
    })), !pivotActive && pivotOn ? /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__cfg-hint"
    }, "Add at least one ", /*#__PURE__*/React.createElement("b", null, "Row"), " field and one ", /*#__PURE__*/React.createElement("b", null, "Value"), " to see the pivot.") : null, /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__cfg-section"
    }, /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__cfg-label"
    }, "Rows"), /*#__PURE__*/React.createElement(__ds_scope.MultiSelect, {
      ...
      className: "twc-dt__cfg-label"
    }, "Columns"), /*#__PURE__*/React.createElement(__ds_scope.MultiSelect, {
      placeholder: "Add column fields\u2026",
      value: pivotConfig.columns,
      options: fieldOpts,
      onChange: vals => setPivotConfig(p => ({
        ...p,
        columns: vals
      }))
    })), /*#__PURE__*/React.createElement("div", {
      ...
      className: "twc-dt__cfg-label"
    }, "Values"), pivotConfig.values.map((v, i) => /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__cfg-row",
      key: v.field + i
    }, /*#__PURE__*/React.createElement("span", {
      className: "twc-dt__cfg-name"
    }, colByField[v.field]?.headerName || v.field), /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__cfg-ctl"
    }, /*#__PURE__*/React.createElement(__ds_scope.Select, {
      size: "sm",
      value: v.agg || "sum",
      options: aggOpts,
      portal: true,
      onChange: a => setPivotConfig(p => ({
        ...p,
        values: p.values.map((x, j) => j === i ? {
          ...x,
          agg: a
        } : x)
      }))
      ...
      onClick: () => setPivotConfig(p => ({
        ...p,
        values: p.values.filter((_, j) => j !== i)
      }))
    }, /*#__PURE__*/React.createElement(Svg, {
      d: I.x
    })))), valueFieldOpts.length ? /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__cfg-add"
    }, /*#__PURE__*/React.createElement(__ds_scope.Select, {
      size: "sm",
      ...
      onChange: f => {
        if (f) {
          setPivotConfig(p => p.values.some(x => x.field === f) ? p : {
            ...p,
            values: [...p.values, {
              field: f,
              agg: "sum"
  ...
  })() : null, panel === "filters" && panelPos ? /*#__PURE__*/React.createElement("div", {
    ...
    className: "twc-dt__panel-title"
  }, "Filters"), filters.length ? /*#__PURE__*/React.createElement("button", {
    className: "twc-dt__link",
    onClick: () => setFilters([])
  }, "Clear all") : null), filters.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "twc-dt__empty",
    style: {
      padding: "16px 12px"
    }
  }, "No filters applied") : filters.map(f => {
    const col = colByField[f.field] || cols[0];
    const ops = opsFor(col.type);
    const op = ops.find(o => o.value === f.op) || ops[0];
    return /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__frow",
      key: f.id
    }, /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__f-col"
    }, /*#__PURE__*/React.createElement(__ds_scope.Select, {
      size: "sm",
      value: f.field,
      ...
      onChange: v => {
        ...
        setFilters(arr => arr.map(x => x.id === f.id ? {
          ...x,
          field: v,
          op: opsFor(nc.type)[0].value,
          value: ""
        } : x));
      }
    })), /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__f-op"
    }, /*#__PURE__*/React.createElement(__ds_scope.Select, {
      size: "sm",
      value: f.op,
      options: ops.map(o => ({
      ...
      onChange: v => setFilters(arr => arr.map(x => {
        ...
        return {
          ...x,
          op: v,
          value: nextMulti ? wasArr ? x.value : [] : wasArr ? "" : x.value
        };
      }))
    })), /*#__PURE__*/React.createElement("div", {
      className: "twc-dt__f-val"
    }, op.noInput ? null : op.multi ? /*#__PURE__*/React.createElement(__ds_scope.MultiSelect, {
      placeholder: "Any of\u2026",
      value: Array.isArray(f.value) ? f.value : [],
      options: optionsForField(f.field),
      onChange: vals => setFilters(arr => arr.map(x => x.id === f.id ? {
        ...x,
        value: vals
      } : x))
    }) : /*#__PURE__*/React.createElement(__ds_scope.Input, {
      ...
      placeholder: "Value",
      value: f.value,
      onChange: e => setFilters(arr => arr.map(x => x.id === f.id ? {
        ...x,
        value: e.target.value
      } : x))
    })), /*#__PURE__*/React.createElement("button", {
      className: "twc-dt__frm-x",
    ...
    onClick: () => addFilter(cols[0].field)
  }, /*#__PURE__*/React.createElement(Svg, {
    d: I.plus,
    style: {
      color: "var(--color-primary)"
...
function Table({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-table-wrap ${className}`
    ...
    }, canSort ? /*#__PURE__*/React.createElement("span", {
      className: "twc-table__sort"
...
function Timeline({
  ...
  return /*#__PURE__*/React.createElement("ul", _extends({
    className: `twc-timeline ${className}`
  }, rest), items.map((it, i) => /*#__PURE__*/React.createElement("li", {
    className: "twc-timeline__item",
    key: i,
    "data-tone": it.tone || undefined
  }, /*#__PURE__*/React.createElement("div", {
    className: "twc-timeline__rail"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-timeline__dot",
    "aria-hidden": "true"
  }, it.icon || null), /*#__PURE__*/React.createElement("span", {
    className: "twc-timeline__line"
  })), /*#__PURE__*/React.createElement("div", {
    className: "twc-timeline__body"
  }, /*#__PURE__*/React.createElement("div", {
    className: "twc-timeline__head"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-timeline__title"
  }, it.title), it.time ? /*#__PURE__*/React.createElement("span", {
    className: "twc-timeline__time"
  }, it.time) : null), it.description ? /*#__PURE__*/React.createElement("div", {
    className: "twc-timeline__desc"
  }, it.description) : null))));
}
...
`;
  ...
  return /*#__PURE__*/React.createElement("label", {
    ...
    className: "twc-check__box",
    "aria-hidden": "true"
  }, /*#__PURE__*/React.createElement("svg", {
    className: "twc-check__svg",
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    strokeWidth: "3.5",
    ...
    className: "twc-check__text"
  }, label ? /*#__PURE__*/React.createElement("span", {
    className: "twc-check__label"
  }, label) : null, description ? /*#__PURE__*/React.createElement("span", {
    className: "twc-check__desc"
...
`;
  ...
  return /*#__PURE__*/React.createElement("label", {
    ...
    className: "twc-radio__dot",
    "aria-hidden": "true"
  }), label || description ? /*#__PURE__*/React.createElement("span", {
    className: "twc-radio__text"
  }, label ? /*#__PURE__*/React.createElement("span", {
    className: "twc-radio__label"
  }, label) : null, description ? /*#__PURE__*/React.createElement("span", {
    className: "twc-radio__desc"
  }, description) : null) : null);
}
...
`;
  ...
  const fieldId = id || autoId;
  return /*#__PURE__*/React.createElement("label", {
    className: `twc-switch ${className}`,
    "data-size": size,
    "data-disabled": disabled || undefined,
    htmlFor: fieldId
  }, /*#__PURE__*/React.createElement("input", _extends({
    ...
    className: "twc-switch__track",
    "aria-hidden": "true"
  }, /*#__PURE__*/React.createElement("span", {
    className: "twc-switch__thumb"
  })), label || description ? /*#__PURE__*/React.createElement("span", {
    className: "twc-switch__text"
  }, label ? /*#__PURE__*/React.createElement("span", {
    className: "twc-switch__label"
  }, label) : null, description ? /*#__PURE__*/React.createElement("span", {
    className: "twc-switch__desc"
  }, description) : null) : null);
}
...
function Node({
  ...
  return /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("button", {
    ...
    className: "twc-tree__ic",
    "aria-hidden": "true"
  }, node.icon) : null, /*#__PURE__*/React.createElement("span", {
    className: "twc-tree__label"
  }, node.label), node.badge != null ? /*#__PURE__*/React.createElement("span", {
    className: "twc-tree__badge"
  }, node.badge) : null), hasChildren && open ? /*#__PURE__*/React.createElement("ul", {
    className: "twc-tree__group twc-tree__group--child"
...
function TreeView({
  ...
  const select = node => {
    if (selectedProp === undefined) setSelInternal(node.id);
    onSelect?.(node);
  };
  return /*#__PURE__*/React.createElement("div", _extends({
    className: `twc-tree ${className}`,
    role: "tree"
  }, rest), /*#__PURE__*/React.createElement("ul", {
    className: "twc-tree__group"
  }, data.map(n => /*#__PURE__*/React.createElement(Node, {
    key: n.id,
    node: n,
    depth: 0,
    expanded: expanded,
...
Object.assign(__ds_scope, { Accordion: __ds_scope.Accordion, Alert: __ds_scope.Alert, Avatar: __ds_scope.Avatar, AvatarMenu: __ds_scope.AvatarMenu, Badge: __ds_scope.Badge, Breadcrumb: __ds_scope.Breadcrumb, Button: __ds_scope.Button, Card: __ds_scope.Card, Carousel: __ds_scope.Carousel, Chart: __ds_scope.Chart, Checkbox: __ds_scope.Checkbox, ColorPicker: __ds_scope.ColorPicker, Combobox: __ds_scope.Combobox, CommandPalette: __ds_scope.CommandPalette, Currency: __ds_scope.Currency, CurrencyField: __ds_scope.CurrencyField, Datatable: __ds_scope.Datatable, DatePicker: __ds_scope.DatePicker, DateRangePicker: __ds_scope.DateRangePicker, Dialog: __ds_scope.Dialog, Divider: __ds_scope.Divider, Drawer: __ds_scope.Drawer, EmptyState: __ds_scope.EmptyState, FileUpload: __ds_scope.FileUpload, IconButton: __ds_scope.IconButton, Input: __ds_scope.Input, Kanban: __ds_scope.Kanban, List: __ds_scope.List, Menu: __ds_scope.Menu, MultiSelect: __ds_scope.MultiSelect, Navbar: __ds_scope.Navbar, Pagination: __ds_scope.Pagination, Popover: __ds_scope.Popover, Progress: __ds_scope.Progress, Radio: __ds_scope.Radio, Rating: __ds_scope.Rating, Select: __ds_scope.Select, Sidebar: __ds_scope.Sidebar, Skeleton: __ds_scope.Skeleton, Slider: __ds_scope.Slider, Spinner: __ds_scope.Spinner, Stat: __ds_scope.Stat, Stepper: __ds_scope.Stepper, Switch: __ds_scope.Switch, Table: __ds_scope.Table, Tabs: __ds_scope.Tabs, Tag: __ds_scope.Tag, Textarea: __ds_scope.Textarea, Timeline: __ds_scope.Timeline, Toast: __ds_scope.Toast, ToastViewport: __ds_scope.ToastViewport, Tooltip: __ds_scope.Tooltip, TreeView: __ds_scope.TreeView });
})(); } catch (e) { __ds_ns.__errors.push({ path: "src/index.ts", error: String((e && e.message) || e) }); }
...
//
// Next.js: the `banner` injects a top-of-file `"use client"` directive into both
// outputs, so every component is a Client Component (they all use hooks/refs/
// browser APIs). In a plain React app (Vite/CRA) that directive is an inert
// string literal — harmless. This is what makes the package importable directly
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "tsup.config.ts", error: String((e && e.message) || e) }); }
...
function DashboardApp() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Ada Park"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
    ...
    actions: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Button, {
      variant: "outline",
      size: "sm",
      leftIcon: /*#__PURE__*/React.createElement(DIcon, {
        name: "Search",
        size: 15
      }),
    ...
    className: "dash__scroll"
  }, /*#__PURE__*/React.createElement("div", {
    className: "dash__head"
  }, /*#__PURE__*/React.createElement("h1", null, "Good morning, Ada"), /*#__PURE__*/React.createElement("p", null, "Here's what's happening across your workspace today.")), /*#__PURE__*/React.createElement("div", {
    className: "dash__kpis"
    ...
    className: "dash__card-h"
  }, /*#__PURE__*/React.createElement("h2", null, "Revenue \xB7 last 7 days"), /*#__PURE__*/React.createElement(Badge, {
    tone: "success",
    dot: true
    ...
    columns: [{
      ...
      headerName: "Member",
      width: 200,
      renderCell: v => /*#__PURE__*/React.createElement("span", {
        style: {
          display: "inline-flex",
          alignItems: "center",
          gap: 9
      ...
      headerName: "Status",
      width: 130,
      valueOptions: ["Active", "Invited", "Suspended"],
      renderCell: v => /*#__PURE__*/React.createElement(Badge, {
        tone: toneFor(v),
        dot: true
      }, v)
    }, {
    ...
    className: "dash__card-h"
  }, /*#__PURE__*/React.createElement("h2", null, "Recent activity"), /*#__PURE__*/React.createElement(IconButton, {
    "aria-label": "More",
    variant: "ghost",
    icon: /*#__PURE__*/React.createElement(DIcon, {
    ...
    items: window.DASH_ACTIVITY.map(a => ({
      title: a.title,
      time: a.time,
      tone: a.tone,
      icon: /*#__PURE__*/React.createElement(DIcon, {
...
try { (() => {
// Mock data for the Twico UI dashboard kit.
window.DASH_MEMBERS = [{
  id: 1,
  name: "Jane Cooper",
  email: "jane@acme.com",
...
window.DASH_ACTIVITY = [{
  title: "Brooklyn upgraded to Team",
  time: "2m ago",
  tone: "success",
  icon: "ArrowUp"
}, {
  title: "New sign-up: Guy Hawkins",
  time: "1h ago",
  tone: "primary",
  icon: "UserPlus"
}, {
  title: "Payment failed — Cody Fisher",
  time: "3h ago",
  tone: "danger",
  icon: "CircleAlert"
}, {
  title: "Jane invited 3 teammates",
  time: "5h ago",
  tone: "primary",
  icon: "Mail"
}, {
...
// ui_kits/showcase/Features.jsx
try { (() => {
const FIcon = window.TwicoIcon;
const {
  Card
} = window.TwicoUiDesignSystem_f2f16a;
function Features() {
  const features = [{
    icon: "Palette",
    title: "Fully themeable",
    body: "Every color, radius, and shadow is a CSS variable. Remap the brand scale to reskin instantly."
  }, {
    icon: "Moon",
    title: "Dark mode built in",
    body: "A single class flips the entire system. Semantic tokens handle the rest, automatically."
  }, {
    icon: "Sparkles",
    title: "Lively motion",
    body: "Spring entrances, click ripples, and smooth transitions — tuned, and reduced-motion aware."
  }, {
    icon: "Smartphone",
    title: "Responsive",
    body: "Designed mobile-first and tested across phone, tablet, and desktop breakpoints."
  }, {
    icon: "Accessibility",
    title: "Accessible",
    body: "Keyboard navigation, focus rings, ARIA roles, and semantic markup come standard."
  }, {
    icon: "Heart",
    title: "Free & open source",
    body: "MIT licensed and free forever — no tiers, no paywalls, no attribution required."
  }];
  ...
  }, "Everything you need"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "var(--color-text-muted)",
      fontSize: 17,
      marginTop: 8
    }
  }, "Thoughtful defaults that scale from prototype to production.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/showcase/Features.jsx", error: String((e && e.message) || e) }); }

// ui_kits/showcase/Footer.jsx
try { (() => {
...
function Footer() {
  const cols = [{
    title: "Product",
    links: ["Components", "Themes", "Templates", "Changelog"]
  }, {
    title: "Docs",
    links: ["Getting started", "Theming", "Dark mode", "Accessibility"]
  }, {
    title: "Community",
    links: ["GitHub", "Discord", "X / Twitter", "Contribute"]
  }];
  return /*#__PURE__*/React.createElement("footer", {
  ...
  }, "Start building with Twico UI"), /*#__PURE__*/React.createElement("p", {
    style: {
      opacity: 0.9,
      fontSize: 16,
      margin: "10px 0 22px"
    }
  }, "Free, open source, and ready for your next project."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 12,
      justifyContent: "center",
    ...
    variant: "solid",
    onClick: () => {},
    className: "twui-cta-light",
    style: {
      background: "#fff",
      color: "var(--color-primary)"
    },
    leftIcon: /*#__PURE__*/React.createElement(FootIcon, {
      name: "Rocket",
      size: 18
    })
  ...
  }, /*#__PURE__*/React.createElement(FootIcon, {
    name: "Blocks",
    size: 18
  })), /*#__PURE__*/React.createElement("span", {
    style: {
  ...
  }, "UI"))), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "var(--color-text-subtle)",
      fontSize: 13.5,
      marginTop: 14,
  ...
  }, "The free React + Tailwind component library. MIT licensed.")), cols.map(c => /*#__PURE__*/React.createElement("div", {
    key: c.title
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
  ...
  }, "\xA9 2026 Twico UI. Released under the MIT License."), /*#__PURE__*/React.createElement("span", {
    style: {
      display: "flex",
      gap: 14,
      color: "var(--color-text-subtle)"
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/showcase/Footer.jsx", error: String((e && e.message) || e) }); }

// ui_kits/showcase/Hero.jsx
try { (() => {
const {
  Button,
  Badge
...
function InstallCmd() {
  ...
  }, "$"), /*#__PURE__*/React.createElement("span", null, "npm i ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--color-primary)",
      fontWeight: 600
    }
  }, "twico-ui")), /*#__PURE__*/React.createElement("span", {
    style: {
      display: "grid",
      placeItems: "center",
      width: 28,
      ...
      color: copied ? "var(--color-success)" : "var(--color-text-subtle)"
    }
  }, /*#__PURE__*/React.createElement(HeroIcon, {
...
function Hero() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    size: "lg",
    dot: true
  }, "v2.0 \u2014 now with 24 components")), /*#__PURE__*/React.createElement("h1", {
    style: {
  ...
  }, "The free React + Tailwind", /*#__PURE__*/React.createElement("br", null), "component library"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 19,
      color: "var(--color-text-muted)",
      maxWidth: 600,
  ...
  }, "Beautifully crafted, fully themeable components with dark mode, motion, and accessibility built in. Open source and free forever."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 12,
      justifyContent: "center",
    ...
    size: "lg",
    rightIcon: /*#__PURE__*/React.createElement(HeroIcon, {
      name: "ArrowRight",
      size: 19
    })
    ...
    size: "lg",
    variant: "outline",
    leftIcon: /*#__PURE__*/React.createElement(HeroIcon, {
      name: "Github",
      size: 18
    })
  ...
  }, /*#__PURE__*/React.createElement(InstallCmd, null))));
}
window.Hero = Hero;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/showcase/Hero.jsx", error: String((e && e.message) || e) }); }

// ui_kits/showcase/Nav.jsx
try { (() => {
const {
  IconButton,
  Button
...
function Nav({
  ...
  return /*#__PURE__*/React.createElement("header", {
    ...
    name: "Star",
    size: 15
  }), " 4.2k"), /*#__PURE__*/React.createElement(IconButton, {
    "aria-label": "GitHub",
    variant: "ghost",
...
window.Nav = Nav;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/showcase/Nav.jsx", error: String((e && e.message) || e) }); }

// ui_kits/showcase/Showcase.jsx
try { (() => {
const TW = window.TwicoUiDesignSystem_f2f16a;
...
function PanelButtons() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    tone: "info"
  }, "Beta"), /*#__PURE__*/React.createElement(Tag, {
    onRemove: () => {}
  }, "react"), /*#__PURE__*/React.createElement(Tag, {
    onRemove: () => {}
  }, "tailwind"), /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: 4
    }
...
function PanelForms() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    leftIcon: /*#__PURE__*/React.createElement(SIcon, {
      name: "User",
      size: 16
    })
  }), /*#__PURE__*/React.createElement(Input, {
    ...
    label: "Workspace",
    placeholder: "acme",
    rightIcon: /*#__PURE__*/React.createElement(SIcon, {
      name: "Check",
      size: 16
    })
  }), /*#__PURE__*/React.createElement("div", {
...
function Showcase() {
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "See it in action"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "var(--color-text-muted)",
      fontSize: 17,
      marginTop: 8
    }
  }, "Every component is interactive, themeable, and dark-mode ready.")), /*#__PURE__*/React.createElement("div", {
    style: {
      borderRadius: "var(--radius-2xl)",
      border: "1px solid var(--color-border)",
      background: "var(--color-surface)",
  ...
  }, "twico-ui/playground.tsx")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 26
    }
    ...
    items: [{
      ...
      }, /*#__PURE__*/React.createElement(PanelButtons, null))
    }, {
      value: "forms",
      label: "Forms",
      content: /*#__PURE__*/React.createElement("div", {
      ...
      }, /*#__PURE__*/React.createElement(PanelForms, null))
    }, {
      value: "data",
      label: "Data",
      content: /*#__PURE__*/React.createElement("div", {
      ...
      }, /*#__PURE__*/React.createElement(PanelData, null))
    }]
  }))));
}
window.Showcase = Showcase;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/showcase/Showcase.jsx", error: String((e && e.message) || e) }); }
...
__ds_ns.CURRENCIES = __ds_scope.CURRENCIES;

__ds_ns.CURRENCY_OPTIONS = __ds_scope.CURRENCY_OPTIONS;

__ds_ns.Currency = __ds_scope.Currency;

__ds_ns.CurrencyField = __ds_scope.CurrencyField;
