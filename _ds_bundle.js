...
`;
  ...
  function Datatable({
    ...
    const densitySyncedRef = import_react.default.useRef(false);
    import_react.default.useEffect(() => {
      if (densitySyncedRef.current) setDensity(densityProp);
      else densitySyncedRef.current = true;
    }, [densityProp]);
    import_react.default.useEffect(() => {
      setAggOn(showAggregation);
    }, [showAggregation]);
    const pageSizeSyncedRef = import_react.default.useRef(false);
    import_react.default.useEffect(() => {
