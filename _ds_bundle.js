...
var TwicoUiDesignSystem_f2f16a = (() => {
  ...
  var SUPPORTS_STYLE_HOIST = parseInt(String(React34.version), 10) >= 19;
  var NonceContext = React34.createContext(void 0);
  function useScopedStyles(id, css) {
    const nonce = React34.useContext(NonceContext);
    React34.useInsertionEffect(() => {
    ...
    return SUPPORTS_STYLE_HOIST ? React34.createElement("style", { href: id, precedence: "twc-ui", nonce }, css) : null;
  }
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "twc-dp__head", children: [
                ...
                /* @__PURE__ */ jsx("button", { type: "button", className: "twc-dp__title", onClick: () => setMode(mode === "days" ? "months" : "days"), children: mode === "days" ? `${months[m]} ${y}` : y }),
              ...
              ] }) : /* @__PURE__ */ jsx("div", { className: "twc-dp__months", children: monthsShort.map((name, i) => /* @__PURE__ */ jsx(
                "button",
                {
                  type: "button",
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "twc-drp__cal", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "twc-drp__grid", children: [
