...
const footer = [
  "---",
  "",
  `_Generated by \`scripts/gen-llms.mjs\` from twico-ui v${pkg.version}. Do not edit by hand — ` +
    "run `npm run gen:llms`. Source of truth: the component `.d.ts` files and `hooks/index.d.ts`._",
  "",
];
